...
export default {
  ...
  methods: {
    ...
    async submitForm(formName) {
      ...
      // var b = new BN("11111111111111111", 2);

      // var res = a.add(b);
      // console.log(res.toString(10)); // 57047
      // const transactionParameters = {
      //   // nonce: "0x00", // 交易系列号，类似id
      //   // gasPrice: "0x09184e72a000", // 油费单价
      //   gas: "0x2710", //油费，非最终真实使用值，真实为 gasUsed
      //   to: "0xC5AAaDBE6fF95fcE36d60580ca78b0637279F47F", // Required except during contract publications.
      //   from: ethereum.selectedAddress, // 发送钱包者地址
      //   // res.toString(10)
      //   // value: "Oxff", // 与 decimal 的乘积
      //   data: "0x7f7465737432000000000000000000000000000000000000000000000000000000600057", // 附属的数据，可做智能合约函数入参
